...
プロジェクトチームの中では、要件定義支援、仕様策定、ソフトウェア設計、コードテストを含むコーディング、機能/品質テスト、プロジェクトマネジメントを担当し、特にソフトウェア設計とプロジェクトマネジメントを得意としております。
また、近年ではマネージャーとして、組織マネジメントやメンバー育成も経験しております。
